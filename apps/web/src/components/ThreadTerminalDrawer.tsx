                ...
                >
                  ...
                  <div className={cn(isSplitGroup && "space-y-0.5")}>
                    {terminalGroup.terminalIds.map((terminalId) => {
                      ...
                      const terminalTabTooltipLabel = `${displayLabel}${customLabel && customLabel !== automaticLabel ? ` · ${automaticLabel}` : ""} — ${resolveTerminalLaunchLocation(terminalId).cwd} · F2 to rename`;
                      return (
                        <div
                          key={terminalId}
                          className={cn(
