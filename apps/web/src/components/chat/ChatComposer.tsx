...
export interface ChatComposerProps {
  ...
  topAttachmentOccupied: boolean;
  onTopDrawerVisibilityChange?: (visible: boolean) => void;
}
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  const {
    ...
    setThreadError,
    onExpandImage,
    topAttachmentOccupied,
    onTopDrawerVisibilityChange,
  } = props;
  ...
  useLayoutEffect(() => {
    onTopDrawerVisibilityChange?.(showComposerTopDrawer);
  }, [onTopDrawerVisibilityChange, showComposerTopDrawer]);
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {!showComposerTopDrawer && !topAttachmentOccupied && !isComposerCollapsedMobile ? (
          <ComposerStashBadge
            count={stashQueue.length}
            menuOpen={isStashMenuOpen}
            pulseKey={stashPulse.key}
